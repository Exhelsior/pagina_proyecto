...
const tokenController = {
    generateToken: async (req, res) => {
        ...
        try {
            ...
            await pool.query('UPDATE usuarios SET reset_token = ? WHERE email = ?', [token, email]);
        ...
        const newPasswordController = {
            updatePassword: async (req, res) => {
                ...
                try {
                    ...
                    const [user] = await pool.query('SELECT * FROM usuarios WHERE reset_token = ?', [recoveryToken]);
